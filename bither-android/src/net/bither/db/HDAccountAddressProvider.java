...
//
//        SQLiteDatabase db = this.mDb.getReadableDatabase();
//        Cursor c = db.rawQuery("select " + AbstractDb.HDAccountColumns.ENCRYPT_SEED + " from " +
//                "hd_account where hd_account_id=? "
//                , new String[]{Integer.toString(hdSeedId)});
//        if (c.moveToNext()) {
...
//                " from hd_account where hd_account_id=? "
//                , new String[]{Integer.toString(hdSeedId)});
//        if (c.moveToNext()) {
...
//        try {
//            SQLiteDatabase db = this.mDb.getReadableDatabase();
//            String sql = "select " + AbstractDb.HDAccountColumns.HD_ACCOUNT_ID + " from " +
//                    AbstractDb.Tables.HD_ACCOUNT;
//            c = db.rawQuery(sql, null);
//            while (c.moveToNext()) {
