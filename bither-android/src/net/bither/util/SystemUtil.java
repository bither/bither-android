...
public class SystemUtil {
	...
	public static void nmNotifyOfWarm(NotificationManager nm, Context context,
			int notifyId, Intent intent, String title, String contentText,
		...
		nm.notify(BitherSetting.NOTIFICATION_ID_COINS_RECEIVED, notification);

	}

	public static void nmNotifyOfCold(NotificationManager nm, Context context,
			int notifyId, Intent intent, String title, String contentText,
			int iconId) {
		final NotificationCompat.Builder builder = new NotificationCompat.Builder(
				context);
