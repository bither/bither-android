...
public class AddressFragmentListItemView extends FrameLayout implements
	...
	private void showAddressInfo() {
		...
		if (this.address.getAddressInfo() != null && address.isReadyToShow()
			...
			if (lastTransaction != null
					&& (lastTransaction.getConfidence().getConfidenceType() == ConfidenceType.BUILDING || lastTransaction
	...
	private void initView() {
		...
		findViewById(R.id.ibtn_address_full).setOnClickListener(
				addressFullClick);
		vTransactionImmuture = (TransactionImmutureSummeryListItemView) findViewById(R.id.v_transaction_immuture);
