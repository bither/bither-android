 ...
 */
public class PinCodeEnableActivity extends SwipeRightActivity implements PinCodeEnterView
    ...
    private void initView() {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText(R.string.pin_code_setting_open);
        pv = (PinCodeEnterView) findViewById(R.id.pv);
        pv.setListener(this);
        pv.setMessage(R.string.pin_code_setting_open_msg);
    }
    ...
    public void onEntered(CharSequence code) {
        ...
        if (firstPin == null) {
            firstPin = code;
            pv.animateToNext();
            pv.setMessage(R.string.pin_code_setting_open_repeat_msg);
        } else {
            if (Utils.compareString(firstPin.toString(), code.toString())) {
                ...
                DropdownMessage.showDropdownMessage(this,
                        R.string.pin_code_setting_open_repeat_wrong);
                pv.setMessage(R.string.pin_code_setting_open_msg);
                pv.shakeToClear();
                firstPin = null;
            }
