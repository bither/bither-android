...
public class BitherAddressProtobufSerializer extends BaseProtobufSerializer {
	@Override
	public BitherAddress readWallet(InputStream input)
		...
		// NetworkParameters params = NetworkParameters.fromID(walletProto
		// .getNetworkIdentifier());
		BitherAddress bitherAddress = new BitherAddress();
