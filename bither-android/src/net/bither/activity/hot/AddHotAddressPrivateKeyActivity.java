 ...
 */
public class AddHotAddressPrivateKeyActivity extends AddPrivateKeyActivity {
    private AddAddressPrivateKeyFragment fragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_hot_address_private_key);
        fragment = (AddAddressPrivateKeyFragment) getSupportFragmentManager().findFragmentById(R
                .id.fragment);
